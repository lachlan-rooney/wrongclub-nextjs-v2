...
const vinamilkProducts = [
  { id: '17', img: '/images/vinamilk-polo.png', title: 'Vinamilk x Wrong Club Polo', price: 8500 },
  { id: '18', img: '/images/vinamilk-long-sleeve.png', title: 'Vinamilk x Wrong Club Long Sleeve', price: 9500 },
...
export default function VinamilkCollabPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="w-full bg-gradient-to-b from-[#0072BC] to-[#0072BC]/90 text-white py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col items-center text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Vinamilk x Wrong Club
            </h1>
            <p className="text-lg md:text-xl text-[#FFF8E7] mb-8 max-w-2xl">
              Nourishing the Next Generation of Vietnamese Golf
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="px-8 py-3 bg-[#FFF8E7] text-[#0072BC] rounded-full font-semibold hover:bg-white transition-colors">
                Shop Collection
              </button>
              <button className="px-8 py-3 border-2 border-[#FFF8E7] text-[#FFF8E7] rounded-full font-semibold hover:bg-[#FFF8E7] hover:text-[#0072BC] transition-colors">
                Learn About First Tee Vietnam
              </button>
            </div>
          </div>
        </div>
